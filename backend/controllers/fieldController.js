...
const registerField = async (req, res) => {
  try {
...
const appealField = async (req, res) => {
...
const uploadFieldDocuments = async (req, res) => {
  const { field_id } = req.params;
  try {
...
const deleteFieldDocument = async (req, res) => {
  const { field_id } = req.params;
...
const replaceSingleDocument = async (req, res) => {
  const { field_id } = req.params;
...
const getFieldFacilities = async (req, res) => {
  const { field_id } = req.params;
  try {
