...
export default function BookingStatsSummary({
  ...
  return (
    <div className={`stats-summary-container ${isCollapsed ? "collapsed" : ""}`}>
      {collapsible && (
        <div
          className="stats-summary-toggle"
        ...
        >
          <div className="toggle-info">
            ...
            <span>
              <strong>สรุปข้อมูลการจอง:</strong> ทั้งหมด <strong>{stats.total || 0}</strong> รายการ | รอตรวจสอบ <strong>{stats.pending || 0}</strong> รายการ
            </span>
          </div>
          <button type="button" className="stats-toggle-btn">
            {isCollapsed ? "แสดงสถิติเพิ่มเติม" : "ซ่อนสถิติ"}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="14"
              height="14"
